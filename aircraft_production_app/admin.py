...
class PartAdmin(admin.ModelAdmin):
    ...
    def delete_model(self, request, obj):
        ...
        try:
            obj.delete() # Modelin override edilmiş delete() metodunu çağırır
    ...
    def delete_queryset(self, request, queryset):
        ...
        for obj in queryset:
            try:
                ...
                # Her bir hata için mesajı kullanıcıya göstermek yerine,
                # sonunda toplu bir özet ve hata listesi verilebilir.
                # Şimdilik basitçe ilk hatayı alalım veya loglayalım.
        ...
        if errors:
            ...
            # Alternatif olarak tüm hataları tek bir mesajda birleştirebilirsiniz.
            # self.message_user(request, f"Bazı parçalar geri dönüştürülemedi: {'; '.join(errors)}", messages.ERROR)
        # Her bir obje için modelin override edilmiş delete() metodunu çağır
